...
<!-- database tracker for isbn code -->
<?php
...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            var submitButton = document.getElementById('submit_sell');
            submitButton.onclick = function(event) {
                var qualField = document.getElementById('quality');
                if (!qualField.getAttribute('data-done')) {
...
<body>
    ...
    <form action="process_sell.php" method="post" id = "sell_book">
